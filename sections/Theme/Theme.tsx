...
export interface Font {
  ...
  fontFamily?: string;
  /**
   * @default @import url('https://fonts.cdnfonts.com/css/louis');
   * \@format css
   */
...
function Section({
  ...
  const variables = [
    ...
    [
      "--font-family",
      fonts?.fontFamily ??
      "Louis, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif",
    ],
  ]
